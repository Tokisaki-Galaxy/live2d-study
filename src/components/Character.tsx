...
const CharacterSVG: React.FC<{ mood: CharacterMood }> = ({ mood }) => {
  ...
  return (
    ...
    >
      {/* Body */}
      <ellipse cx="100" cy="140" rx="50" ry="45" fill={colors.primary} />

      {/* Head */}
      <circle cx="100" cy="85" r="40" fill={colors.primary} />

      {/* Ears */}
      <path d="M65 65 L55 30 L85 55 Z" fill={colors.secondary} />
      <path d="M135 65 L145 30 L115 55 Z" fill={colors.secondary} />

      {/* Inner ears */}
      <path d="M68 60 L62 40 L80 55 Z" fill="#fde68a" />
      <path d="M132 60 L138 40 L120 55 Z" fill="#fde68a" />
      ...
      {mood === "sleep" ? (
        <>
          {/* Closed eyes */}
          <path
            d="M75 85 Q85 90 95 85"
            stroke={colors.secondary}
            strokeWidth="3"
            fill="none"
          />
          <path
            d="M105 85 Q115 90 125 85"
            stroke={colors.secondary}
            strokeWidth="3"
            fill="none"
          />
      ...
      {/* Nose */}
      <path d="M95 95 L105 95 L100 102 Z" fill="#f472b6" />
  ...
  return (
    <div className="relative flex flex-col items-center justify-center">
      ...
      {bubbleVisible && message && (
        <div className="absolute -top-16 lg:-top-24 left-1/2 -translate-x-1/2 w-48 lg:w-64 animate-fade-in z-50 pointer-events-none">
          <div
      ...
      {/* Character name */}
      <p className="mt-4 text-white/50 text-sm font-medium tracking-wider uppercase">
        Momo
      </p>
    </div>
  );
